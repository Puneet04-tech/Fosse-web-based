...
class MainWindow(QMainWindow):
    ...
    def create_visualization_tab(self):
        ...
        # Show test chart immediately
        QTimer.singleShot(500, lambda: self.update_chart_type("Test Chart (Always Visible)"))
    ...
    def create_test_chart(self):
        ...
        ax.set_title('📊 Test Chart - Equipment Performance', fontsize=16, fontweight='bold', pad=20)
    ...
    def create_equipment_distribution_chart(self):
        ...
        # Try multiple possible keys for equipment data
        equipment = None
        ...
        elif 'equipment_distribution' in summary:
            equipment = summary['equipment_distribution']
        ...
        if not sizes or sum(sizes) == 0:
            sizes = [25, 25, 25, 25]  # Default values
    ...
    def create_parameter_analysis_chart(self):
        ...
        bars = ax.bar(range(len(averages)), averages.values, color=colors, alpha=0.8)
...
Statistical Averages:"""
    ...
    def create_anomaly_detection_chart(self):
        ...
        # Handle different anomaly data formats
        ...
        colors = ['#FF6B6B', '#FF8E53', '#FF6348', '#DC143C', '#B22222']
        colors = colors[:len(labels)]
